...
class CallService {
  ...
  void _handleMessage(Map<String, dynamic> msg) {
    ...
    switch (type) {
      ...
      case 'call_offer':
        _handleOffer(
            Map<String, dynamic>.from(msg['data']), msg['room_id']);
        break;
      case 'call_answer':
        _handleAnswer(Map<String, dynamic>.from(msg['data']));
        break;
      case 'call_ice':
        _handleIceCandidate(Map<String, dynamic>.from(msg['data']));
        break;
    }
  }
  ...
  Future<void> _handleOffer(
      Map<String, dynamic> data, dynamic roomId) async {
